...
namespace engine
{
    ...
    void Animator::SetAnimationData(const std::string& path)
    {
    ...
    void Animator::PlayCrossFade(int index, float transitionDuration, bool loop)
    {
        if (!m_animationData)
        {
            LOG_INFO("AnimationData 없음");
    ...
    void Animator::PlayCrossFade(const std::string& animationName, float transitionDuration, bool loop)
    {
        if (!m_animationData)
        {
            LOG_INFO("AnimationData 없음");
    ...
    void Animator::Update()
    {
        ...
        if (m_skeleton.empty())
        {
            ...
            if (renderer && renderer->GetSkeletonData())
            {
    ...
    const BoneMatrixArray& Animator::GetFinalBoneMatrices() const
    {
    ...
    void Animator::Save(json& j) const
    {
    }

    void Animator::Load(const json& j)
    {
    }

    std::string Animator::GetType() const
    {
        return "Animator";
    }
